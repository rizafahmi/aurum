...
config :aurum, AurumWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AurumWeb.ErrorHTML, json: AurumWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Aurum.PubSub,
  live_view: [signing_salt: "PXhfQ1T2"]
...
config :aurum, Aurum.Mailer, adapter: Swoosh.Adapters.Local
